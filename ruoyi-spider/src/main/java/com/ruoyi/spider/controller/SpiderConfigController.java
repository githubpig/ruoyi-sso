...
public class SpiderConfigController extends BaseController
{
    ...
    {
        List<String> pipelineList=ComponentPipelineManager.getPipelineList();
        modelMap.addAttribute("pipelineList",pipelineList);
        return prefix + "/add";
    }
    ...
    public String edit(@PathVariable("id") Long id, ModelMap modelMap)
    {
        ...
        modelMap.put("spiderConfig", spiderConfig);
        return prefix + "/edit";
    }
